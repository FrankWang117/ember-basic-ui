export default function draw(d) {
	...
	!(function (e) {
		if (document.addEventListener) {
			...
			document.attachEvent && (o = e, n = d.document, c = !1, i = function () {
				c || (c = !0, o());
			}, (l = function () {
				try {
		...
		(e = document.createElement('div')).innerHTML = l, l = null, (t = e.getElementsByTagName('svg')[0]) && (t.setAttribute('aria-hidden', 'true'), t.style.position = 'absolute', t.style.width = 0, t.style.height = 0, t.style.overflow = 'hidden', o = t, (n = document.body).firstChild ? (c = o, (i = n.firstChild).parentNode.insertBefore(c, i)) : n.appendChild(o));
	});
}